...
double getUnixTime()
{
    static double firstCallTimeMs;
    static double firstCallTime;
    static bool isFirstCall = true;

    if (isFirstCall) {
        firstCallTime = (double)time(NULL);
        firstCallTimeMs = getTimeMs();
        isFirstCall = false;
    }

    return firstCallTime - firstCallTimeMs + getTimeMs();
}
