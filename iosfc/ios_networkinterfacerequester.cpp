...
NetworkInterfaceRequester::NetworkInterfaceRequester()
{
    impl = factory->createNetworkInterfaceRequesterImpl();
}
...
std::vector<NetworkInterface> NetworkInterfaceRequester::getInterfaces()
{
