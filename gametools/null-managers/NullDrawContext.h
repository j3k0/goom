...
public:
    ...
    virtual void nextDrawAlpha(float a) {}
...
{
public:
    virtual float getTextWidth(const char *text) { return 16; }
    virtual float getTextHeight(const char *text) { return 16; }
    virtual float getHeight()   { return 16; }
    virtual float getLineSkip() { return 16; }
};
