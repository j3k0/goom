...
public:
    ...
    virtual void pushMouseEvent(unsigned int mouseId, int x, int y, event_manager::CursorEventType type);
    virtual void pushCursorEvent(event_manager::CursorEventType type, bool isDown);
