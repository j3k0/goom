...
public:
    ...
    virtual int streamSkip(int size) = 0; // Skip 'size' bytes
};
...
class MultiPackageDataPathManager : public DataPathManager {
public:
    virtual int numPackages() const = 0;
    virtual DataPackage &getPackage(int i) = 0;
};
